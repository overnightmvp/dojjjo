/**
 * The Pitch Office Core JavaScript Library
 * Centralized functionality for language switching, theme management, and analytics
 */
...
// Application state
let currentLanguage = localStorage.getItem('preferred-language') || 'fr';
 ...
 * @param {Object} config - Brand configuration object
 */
function initializePitchOffice(config) {
    CONFIG = config;
